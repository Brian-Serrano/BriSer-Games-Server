...
from cube_jump_utils.database import Player, CJRefreshToken
from cube_jump_utils.utils import validate_username, validate_email, validate_password, create_access_token, \
    create_refresh_token

authorization_routes = Blueprint("cj_authorization_routes", __name__)
...
def refresh():
    ...
    stored_token = CJRefreshToken.query.filter_by(token=token).first()
    if not stored_token:
